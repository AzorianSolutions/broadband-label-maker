...
CONTEXT_SETTINGS = dict(auto_envvar_prefix="BBL")
version: str = '0.1.0'
...
class Environment:
    ...
    def load_settings(self, env_file: str, env_file_encoding: str, secrets_dir: str | None) -> AppSettings:
        ...
        os.putenv('BBL_ENV_FILE', env_file)
        os.putenv('BBL_ENV_FILE_ENCODING', env_file_encoding)
        ...
        if secrets_dir is not None:
            ...
            if valid:
                ...
                os.putenv('BBL_ENV_SECRETS_DIR', secrets_dir)
